...
import { stripGarbageNewLines } from "./LLMutils";
...
export class LLMIO extends LLM {
  ...
  private async _initialize(): Promise<void> {
    try {
      ...
      this.chunks = LLMIO.segmentText(this.text, this.chunkSize);
  ...
  private static segmentText(text: string, chunkSize: number): string[] {
