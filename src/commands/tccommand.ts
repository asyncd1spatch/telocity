  ...
  static get MODELS_TO_DOWNLOAD(): Readonly<{
    ...
    return {
      qwen: [
        ...
        "https://huggingface.co/Qwen/Qwen3-4B-Instruct-2507/resolve/main/tokenizer_config.json",
      ],
      gemma: [
        "https://huggingface.co/unsloth/gemma-3n-E4B/resolve/main/tokenizer.json",
        "https://huggingface.co/unsloth/gemma-3n-E4B/resolve/main/tokenizer_config.json",
      ],
      hy: [
        "https://huggingface.co/tencent/HY-MT1.5-1.8B/resolve/main/tokenizer.json",
        "https://huggingface.co/tencent/HY-MT1.5-1.8B/resolve/main/tokenizer_config.json",
      ],
    } as const;
  }
